defmodule Cldr.PersonName.FormatTest do
  ...
  @tests 1..500
  @test_locales [:en, :fr, :de, :es, :it, :pl, :ru, :th, :da, :en_AU, :en_CA, :en_GB, :en_IN, :pt, :pt_PT, :ja]

  # for test <- Cldr.PersonName.TestData.parse_all_locales() do
  for test <- Cldr.PersonName.TestData.parse_locales(@test_locales), test.line in @tests do
